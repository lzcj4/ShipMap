"""
Django settings for ShipMap project.
...
SECRET_KEY = 'o0jmt-q61*t!h)n-%#r(+t2t(@h@iwn0_^ywihfg$@bztnz)%e'
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "ROUTING": "ShipMap.routing.channel_routing",
    },
}
